      ...
      <section id="registration-form" className="bg-[#062d3a] px-5 py-24 text-white lg:px-10 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-white/65">Complete the form below to join SOMI for the Cancer Walk 2026.</p>
          </div>
          <div className="mx-auto mt-12 max-w-3xl overflow-hidden rounded-[2rem] border border-white/10 bg-white p-2 shadow-2xl shadow-black/20 sm:p-4">
            <iframe
              ...
              src="https://docs.google.com/forms/d/e/1FAIpQLScPFBUlANGtbpflULxzVYOe4LItiPmdEHDjXKIrYnRY8tuZTg/viewform?embedded=true"
